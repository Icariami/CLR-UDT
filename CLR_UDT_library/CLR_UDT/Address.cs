...
namespace CLR_UDT
{
    ...
    internal class Address : INullable, IBinarySerialize
    {
        ...
        public SqlMetaData[] GetSqlMetaData()
        {
            ...
            metaData[0] = new SqlMetaData("Street", SqlDbType.NVarChar, 50, 54); 
            metaData[1] = new SqlMetaData("BuildingNumber", SqlDbType.Int, 4, 6);  
            metaData[2] = new SqlMetaData("ApartmentNumber", SqlDbType.Int, 4, 6); 
            metaData[3] = new SqlMetaData("ZipCode", SqlDbType.NVarChar, 10, 14);
            metaData[4] = new SqlMetaData("City", SqlDbType.NVarChar, 50, 54);
            metaData[5] = new SqlMetaData("Country", SqlDbType.NVarChar, 50, 54); 
